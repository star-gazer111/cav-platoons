...
def generate_launch_description():
    ...
    # 2. Spawn STATIONARY Obstacle (Red Box)
    # Spawning exactly at x=3.0 as requested
    spawn_obstacle = Node(
        package='gazebo_ros',
    ...
    # Ensure the obstacle remains stationary (0.0 m/s)
    ...
    # Spaced exactly 0.5m apart to match the D_HEADWAY in the node
