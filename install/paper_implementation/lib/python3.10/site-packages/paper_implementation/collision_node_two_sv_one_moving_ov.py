...
# Keep the collision envelope consistent with the actual lane spacing.
# The earlier radius made the right-lane center almost collide by design,
# so the DWA often concluded that every overtake trajectory was infeasible.
BURGER_RADIUS = 0.14
